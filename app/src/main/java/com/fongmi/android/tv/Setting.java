...
public class Setting {
    ...
    public static int getDownload() {
        return Prefers.getInt("download", 1);
    }
    ...
    public static int getLiveSwitch() {
        return Prefers.getInt("liveSwitch", 0);
    }

    public static void setLiveSwitch(int isOn) {
        Prefers.put("liveSwitch", isOn);
    }
    //end if
}
